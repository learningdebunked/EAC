...
def main():
    ...
    print(f"  Users: {stats['original_users']:,}")
    print(f"  Products: {stats['original_products']:,}")
    print(f"  Transactions: {stats['original_transactions']:,}")
    print(f"\nFiltered Data (active users & popular products):")
    print(f"  Users: {stats['n_users']:,}")
    print(f"  Products: {stats['n_items']:,}")
    print(f"  Interactions: {stats['n_interactions']:,}")
    print(f"  Avg Purchases/User: {stats['avg_purchases_per_user']:.1f}")
    print(f"  Avg Users/Product: {stats['avg_users_per_product']:.1f}")
    print(f"\nMatrix Statistics:")
